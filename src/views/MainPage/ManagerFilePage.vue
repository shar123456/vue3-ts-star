...
import { ManagerFileDataEntity,IManagerFileInfo,ManagerFileColumns } from "../../TypeInterface/IManagerFlieInterface";
...
import {
 GetFileDatas,ExportFile,DeleteFileById,BatchDeleteFile
...
import {
  ...
  CopyOutlined,
  SettingOutlined,
  SettingFilled,CloudDownloadOutlined ,CloudFilled
} from "@ant-design/icons-vue";
export default defineComponent({
  components: {
    ManagerFileQueryHeader,UpLoadFileModal,ExclamationCircleOutlined,DeleteTwoTone,CloudDownloadOutlined,CloudFilled,
    configGridModal
  },
  setup() {
  ...
  const FileExtension = record.fileType;
     ...
     let typeContent="";
        switch (FileExtension)
                {
                    case "xls": typeContent = "application/vnd.ms-excel"; break;
                    case "xlsx": typeContent = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"; break;
                    case "docx": typeContent = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"; break;
                 case "txt": typeContent = "text/plain"; break;
